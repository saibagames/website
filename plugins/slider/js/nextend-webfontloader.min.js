    ...
    function() {
        ...
        function h(t, n, i) {
            ...
            nt ? (n.onload = function() {
                ...
                s = !0, c = Error("Stylesheet failed to load"), e()
            }) : setTimeout(function() {
                s = !0, e()
            }, 0), a(t, "head", n)
        }
        ...
        function k(t) {
            t.g && r(t.f, [t.a.c("wf", "loading")]), N(t, "loading")
        }
        ...
        function I(t, n, i, e, o, a, s) {
            this.v = t, this.B = n, this.c = i, this.a = e, this.s = s || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = a || null, this.m = this.j = this.h = this.g = null, this.g = new A(this.c, this.s), this.h = new A(this.c, this.s), this.j = new A(this.c, this.s), this.m = new A(this.c, this.s), t = new w(this.a.c + ",serif", b(this.a)), t = W(t), this.g.a.style.cssText = t, t = new w(this.a.c + ",sans-serif", b(this.a)), t = W(t), this.h.a.style.cssText = t, t = new w("serif", b(this.a)), t = W(t), this.j.a.style.cssText = t, t = new w("sans-serif", b(this.a)), t = W(t), this.m.a.style.cssText = t, E(this.g), E(this.h), E(this.j), E(this.m)
        }
        ...
        function B(t) {
            var n, i = t.g.a.offsetWidth,
                e = t.h.a.offsetWidth;
            (n = i === t.f.serif && e === t.f["sans-serif"]) || (n = O() && P(t, i, e)), n ? tt() - t.A >= t.w ? O() && P(t, i, e) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? L(t, t.v) : L(t, t.B) : D(t) : L(t, t.v)
        }
        ...
        function R(t) {
            0 == --t.f && t.j && (t.m ? (t = t.a, t.g && r(t.f, [t.a.c("wf", "active")], [t.a.c("wf", "loading"), t.a.c("wf", "inactive")]), N(t, "active")) : T(t.a))
        }
                ...
                if (0 === e.length && s) T(n.a);
                    ...
                    for (f = 0; f < e.length; f++) {
                        var l = e[f],
                            ...
                            p = n.a,
                            g = l;
                        if (p.g && r(p.f, [p.a.c("wf", g.c, b(g).toString(), "loading")]), N(p, "fontloading", g), p = null, null === ot)
                            if (window.FontFace) {
                                var g = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent),
                                    d = /OS X.*Version\/10\..*Safari/.exec(window.navigator.userAgent) && /Apple/.exec(window.navigator.vendor);
                                ot = g ? 42 < parseInt(g[1], 10) : !d
                            } else ot = !1;
        ...
        function M(t, n, i) {
            ...
            var e = C(t.a, i, t.c),
                a = new $(t.c, n, o);
            for (t.h = e.length, n = 0, i = e.length; i > n; n++) e[n].load(function(n, i, e) {
                H(t, a, n, i, e)
            })
        }
        ...
        function K(t, n) {
            t ? this.c = t : this.c = at, this.a = [], this.f = [], this.g = n || ""
        }
        ...
        function V(t) {
            ...
            for (var n = t.a.length, i = [], e = 0; n > e; e++) i.push(t.a[e].replace(/ /g, "+"));
                ...
                if (2 <= e.length) {
                    ...
                    if (s = [], r)
                        for (var r = r.split(","), c = r.length, f = 0; c > f; f++) {
                            var h;
                            if (h = r[f], h.match(/^[\w-]+$/)) {
                                var l = ft.exec(h.toLowerCase());
                                if (null == l) h = "";
                                else {
                                    if (h = l[2], h = null == h || "" == h ? "n" : ct[h], l = l[1], null == l || "" == l) l = "4";
                                    else var u = rt[l],
        ...
        $.prototype.g = function(t) {
            var n = this.a;
            n.g && r(n.f, [n.a.c("wf", t.c, b(t).toString(), "active")], [n.a.c("wf", t.c, b(t).toString(), "loading"), n.a.c("wf", t.c, b(t).toString(), "inactive")]), N(n, "fontactive", t), this.m = !0, R(this)
        }, $.prototype.h = function(t) {
            var n = this.a;
            if (n.g) {
                var i = c(n.f, n.a.c("wf", t.c, b(t).toString(), "active")),
                    e = [],
                    o = [n.a.c("wf", t.c, b(t).toString(), "loading")];
                i || e.push(n.a.c("wf", t.c, b(t).toString(), "inactive")), r(n.f, e, o)
            }
            N(n, "fontinactive", t), R(this)
        }, q.prototype.load = function(t) {
            this.c = new e(this.j, t.context || this.j), this.g = !1 !== t.events, this.f = !1 !== t.classes, M(this, new j(this.c, t), t)
                ...
                if (a["__mti_fntLst" + e]) {
                    ...
                    if (o)
                        for (var r = 0; r < o.length; r++) {
                            ...
                            void 0 != o[r].fontStyle && void 0 != o[r].fontWeight ? (i = o[r].fontStyle + o[r].fontWeight, s.push(new w(c, i))) : s.push(new w(c))
                        }
                    t(s)
            ...
            var n, i, e = this.a.urls || [],
                ...
                s = new u;
            for (n = 0, i = e.length; i > n; n++) h(this.c, e[n], p(s));
            var r = [];
        ...
        var at = "https://fonts.googleapis.com/css",
            ...
            ft = /^(thin|(?:(?:extra|ultra)-?)?light|regular|book|medium|(?:(?:semi|demi|extra|ultra)-?)?bold|black|heavy|l|r|b|[1-9]00)?(n|i|normal|italic)?$/,
            ht = {
                Arimo: !0,
                Cousine: !0,
                Tinos: !0
        ...
        Q.prototype.load = function(t) {
            ...
            n ? (i.__webfontfontdeckmodule__ || (i.__webfontfontdeckmodule__ = {}), i.__webfontfontdeckmodule__[n] = function(n, i) {
                for (var o = 0, a = i.fonts.length; a > o; ++o) {
                    var s = i.fonts[o];
                    e.a.push(new w(s.name, x("font-weight:" + s.weight + ";font-style:" + s.style)))
                }
                t(e.a)
            }, l(this.c, (this.f.api || "https://f.fontdeck.com/s/css/js/") + f(this.c) + "/" + n + ".js", function(n) {
                n && t([])
            })) : t([])
        };
        var lt = new q(window);
        ...
        window.WebFont = ut, window.WebFontConfig && lt.load(window.WebFontConfig)
    }(), N2D("nextend-webfontloader");